...
const NAV_ITEMS = [
  ...
  { key: 'channels',  label: 'Channels', icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="6" height="5" rx="1.2"/><rect x="16" y="3" width="6" height="5" rx="1.2"/><rect x="9" y="16" width="6" height="5" rx="1.2"/><path d="M5 8v4h14V8"/><path d="M12 12v4"/></svg> },
